...
namespace BakeryEngine.Graphics.OpenGL
{
    public class GLVertexArrayObject<TVertexType, TIndexType> : IDisposable where TVertexType : unmanaged where TIndexType : unmanaged
    {
